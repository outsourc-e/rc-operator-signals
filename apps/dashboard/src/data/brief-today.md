...
> Generated: 2026-08-23T06:46:33.859Z

Dark Noise operator brief — 28d: MRR $4,717, revenue $4,247. Top signal: MRR exceeds Revenue by 10.0%. Next: audit what changed 3-4 weeks ago, since that is where the current trends were seeded.

## KPI snapshot
- **Active Trials**: 46
- **Active Subscriptions**: 2,605
- **MRR**: $4,717
- **Revenue**: $4,247
- **New Customers**: 1,219
- **Active Users**: 12,400
...
## Fired signals
- **MRR exceeds Revenue by 10.0%**: MRR ($4,717) exceeds 28-day revenue ($4,247). Refunds, churn, or collection timing may be depressing cash below the run-rate.
- **New customers are 47% of active subs in 28d**: 1,219 new customers arrived against a paid base of 2,605. Growth is healthy, but conversion to paying may still be leaving money on the table.
