...
- **Primary execution agent** was Claude Opus 4.6/4.7, running inside my own OpenClaw harness. That's what wrote the code, the specs, the docs, most of the thinking.
